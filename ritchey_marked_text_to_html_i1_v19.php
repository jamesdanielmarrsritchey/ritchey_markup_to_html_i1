...
# Meta
/*
Name: Ritchey Marked Text To HTML i1 v19
...
*/
# Content
if (function_exists('ritchey_marked_text_to_html_i1_v19') === FALSE){
function ritchey_marked_text_to_html_i1_v19($source_file, $destination_file, $css_file = NULL, $overwrite = NULL, $display_errors = NULL){
	$errors = array();
...
HEREDOC;
	...
	if ($display_errors === TRUE){
		if (@empty($errors) === FALSE){
			...
			if (function_exists('ritchey_marked_text_to_html_i1_v19_format_error') === FALSE){
				function ritchey_marked_text_to_html_i1_v19_format_error($errno, $errstr){
					echo $errstr;
				}
			}
			set_error_handler("ritchey_marked_text_to_html_i1_v19_format_error");
